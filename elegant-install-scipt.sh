...
# Description: <Determine and install corresponding Linux Kernel.>
# Author: <Kevin>
# Version: 1.0.0
# License: MIT License
#
...
if [ "$EUID" -ne 0 ]; then # Check root permission
    echo "Error, your permission is far from the absolute perfection. Please come again later after you have acquired what it truly is."
    exit 1
fi
...
echo "Subsequently, the gift of the creation must be laid and inspected wisely. With all the wisdom, I shall declare a way to inspect it the Extracting."
sleep 5
...
echo "I shall ask you to do something for me: embedding your creativity to this own creation. This is the essential stage, please do all of this by yourself. Hence, the gift can be done."
sleep 3
make menuconfig
...
echo "With all of the grace, the grub shall receive the same treatment a new form - a new beauty of the creation."
sleep 3
update-grub || { echo "Once again, the only thing that declined the evolution, has always been the GRUB."; exit 1; }
...
if [[ "$REBOOT" =~ ^[Yy]$ ]]; then
    echo "Farewell my noble friend, this long trip may end with a reboot of your computer."
    sleep 3
    reboot
else
